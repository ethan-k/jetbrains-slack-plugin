...
class DeploymentPluginConfigurable(project: Project) : Configurable {
    ...
    private lateinit var githubApiTokenField: JTextField // New field
    ...
    override fun createComponent(): JComponent {
        ...
        githubApiTokenField = JTextField(30) // Initialize new field
        ...
        addLabelAndField(panel, c, "GitHub API Token:", githubApiTokenField, 2) // Add new field
