...
class SettingsService(val project: Project) {
    companion object {
        ...
        private const val GITHUB_API_TOKEN_KEY = "githubApiToken"
    }
    ...
    var updatePeriod: Long
        get() = properties.getValue(UPDATE_PERIOD_KEY, "300000").toLongOrNull() ?: 300000L // 5 minutes
        set(value) {
    ...
    var githubApiToken: String
        get() = properties.getValue(GITHUB_API_TOKEN_KEY) ?: ""
        set(value) = properties.setValue(GITHUB_API_TOKEN_KEY, value)
